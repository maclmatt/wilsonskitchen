...
class TablesMenu():
    ...
    def show_add_table(self):
        ...
        self.add_new_booking_button = tk.Button(self.frame, text="Add Table", command=self.add_new_table)
        self.add_new_booking_button.grid(row=2, column=0, columnspan=2, sticky="ew", padx=10, pady=10)
